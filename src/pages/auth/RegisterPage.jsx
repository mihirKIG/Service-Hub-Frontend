...
const RegisterPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-pink-50 via-purple-50 to-white px-4 py-8">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold bg-gradient-to-r from-pink-600 to-purple-600 bg-clip-text text-transparent mb-2">ServiceHub</h1>
            ...
            <>
              ...
              <form onSubmit={handleSendOTP} className="space-y-6">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full pl-14 pr-3 py-2.5 border-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-transparent text-lg ${
                ...
                <Button
                  ...
                  fullWidth
                  disabled={phoneLoading}
                  className="bg-gradient-to-r from-pink-600 to-purple-600 hover:from-pink-700 hover:to-purple-700 text-white font-semibold py-3 text-lg shadow-lg shadow-pink-200"
                >
                  {phoneLoading ? (
              ...
              <div>
                <button
                  ...
                  className="w-full flex items-center justify-center gap-3 px-4 py-3 border-2 border-purple-200 rounded-lg hover:bg-purple-50 hover:border-purple-300 transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-sm"
                >
                  {googleLoading ? (
                    <>
                      <Loading size="sm" />
            ...
            <>
              ...
              <div className="mb-6">
                ...
                <p className="text-gray-600">
                  ...
                  <span className="font-semibold text-pink-600">+88{phoneNumber}</span>
                </p>
              </div>
              ...
              <Button
                ...
                className="bg-gradient-to-r from-pink-600 to-purple-600 hover:from-pink-700 hover:to-purple-700 text-white font-semibold py-3 text-lg mb-4 shadow-lg shadow-pink-200"
              >
                {otpLoading ? (
                  <span className="flex items-center justify-center">
                    <Loading size="sm" />
              ...
              <div className="text-center">
                {canResend ? (
                  ...
                  <p className="text-sm text-gray-600">
                    Resend code in <span className="font-semibold text-pink-600">{resendTimer}s</span>
                  </p>
                )}
              </div>
            </>
