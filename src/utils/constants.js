...
export const ROUTES = {
  ...
  PROVIDER_APPLICATION: '/provider-application/:postId',
  MY_APPLICATIONS: '/my-applications',
  
  // Provider Dashboard
  PROVIDER_DASHBOARD: '/provider/dashboard',
  PROVIDER_SERVICES: '/provider/services',
  PROVIDER_ADD_SERVICE: '/provider/services/add',
  PROVIDER_EDIT_SERVICE: '/provider/services/edit/:id',
  PROVIDER_ORDERS: '/provider/orders',
  PROVIDER_ORDER_DETAIL: '/provider/orders/:id',
