...
const BecomeProvider = lazy(() => import('@pages/provider/BecomeProvider'));
const ProviderApplication = lazy(() => import('@pages/provider/ProviderApplication'));
const MyApplications = lazy(() => import('@pages/provider/MyApplications'));
  ...
  return (
    <Suspense fallback={<Loading fullScreen />}>
      <Routes>
        ...
        {/* Provider Application Pages - Public */}
        <Route path={ROUTES.BECOME_PROVIDER} element={<BecomeProvider />} />
        <Route path={ROUTES.PROVIDER_APPLICATION} element={<ProviderApplication />} />
        <Route path={ROUTES.MY_APPLICATIONS} element={<MyApplications />} />
          ...
          <Route element={<ProviderRoute />}>
            <Route element={<ProviderDashboardLayout />}>
              ...
              <Route path={ROUTES.PROVIDER_SERVICES} element={<ProviderServices />} />
              <Route path={ROUTES.PROVIDER_ORDERS} element={<ProviderOrders />} />
